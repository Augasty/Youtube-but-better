...
{/* this path can be checked by console logging the channelDetail prop */}
...
{/* this channelDetail.statistics.subscriberCount is not available in channelDetail right now */}
